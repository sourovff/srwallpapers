...
import { getDatabase, ref, onValue, set, push, update, remove } from "https://www.gstatic.com/firebasejs/12.15.0/firebase-database.js";
...
// 🔑 আপনার Firebase UID এখানে দিন
const ADMIN_UID = "আপনার_UID_এখানে_দেন";
...
function initAdminPanel() {
  ...
  document.addEventListener('keydown', (e) => {
    if (e.key === 'Escape') {
      document.getElementById('editModal').classList.remove('show');
      document.getElementById('previewModal').classList.remove('show');
      const video = document.getElementById('previewContainer').querySelector('video');
      if (video) video.pause();
    }
  });
...
// 🔑 ADMIN UID (SHAON)
// ============================================================
const ADMIN_UID = "kP7A29SA8tb84GhcdLyvNudf30M2"; // ✅ আপনার UID
